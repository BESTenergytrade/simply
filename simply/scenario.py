""" Class Scenario represents different scenarios and defines the proporties of a random scenario.
Directories are created for the Parameters of the class where the information is saved and the random scenario gets the information from. 
...
def from_dict(scenario_dict):
    """
    last item of the dictonary is removed after used and checks if the quantity of the dictionary is 0. Variables are created with "network", "pn" and "actors".
    Parameters
    ----------
    scenario_dict
...
def load(dirpath):
    """
    Create scenario from files that were generated by Scenario.save(). Creates empty list for actors and then loads actors into the list simultaneously.
    Parameters
    ----------
    dirpath: string
...
def create_random(num_nodes, num_actors):
    """
    creates random scenario from given number of nodes and actors
    Parameters
    ----------
    num_nodes: integer
    num_actors: integer
