"""
 JuH: The script scenario.py defines the proporties of a scenario. It also has functions to create a random scenario from scratch.
...
class Scenario:
    def __init__(self, network, actors, map_actors, rng_seed=None):
        ...
        actors: iterable of actor instances
        map_actors: dictionary linking all actor ID to power node ID.
        rng_seed: rng_seed is optional and can be used to have reproducible results
    ...
    def __str__(self):
        """JuH: returns a long string containing all the scenario data.
        Returns
        -------
        object
        """
    ...
    def to_dict(self):
        """StS: put all the scenario data in a dictionary, used for saving"""
        return {
    ...
    def save(self, dirpath):
        """StS: save scenario instance to hard drive"""
...
def from_dict(scenario_dict):
    """
    StS: generates new scenario from dictionary. Used when loading. The power network is retrieved and makes sure only one such network is given.
    Parameters
    ----------
    scenario_dict: list
    ...
    -------
    object: dict
        new Scenario instance with parameters of the scripts "actor" and "power_network"
    """
...
def load(dirpath):
    """
    JuH: Create scenario from files that were generated by Scenario.save().
    Parameters
    ----------
    dirpath: string
    ...
    Returns
    -------
    object: new Scenario instance with parameters defined above
    """
...
def create_random(num_nodes, num_actors):
    """
    JuH: creates random scenario with given number of nodes and actors
